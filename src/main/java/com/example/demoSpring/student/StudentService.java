...
import com.example.demoSpring.EmailValidator;
import com.example.demoSpring.exception.ApiRequestException;
...
public class StudentService {
    ...
    void addNewStudent(Students student) {
        addNewStudent(null,student);
    }

     void addNewStudent(UUID studentId,Students student) {
         UUID newStudentId = Optional.ofNullable(studentId).orElse(UUID.randomUUID());

         //TODo: Verift that email is not taken
